...
const Home = () => {
    return (
        <div>
            ...
            <h1 className="lg:text-4xl text-2xl text-center font-medium mt-28">Volunteer Communication</h1>
            ...
            <section className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 max-w-6xl mx-auto mt-10">
                <div className="mx-auto max-w-[350px] space-y-4 rounded-lg  bg-[#E5F5F2] p-6 shadow-lg md:w-[350px]  text-black">
